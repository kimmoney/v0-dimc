...
export default function ManagerEdit() {
  ...
  useEffect(() => {
    const result = {
      ...
      lecture_time: 1,
      lecture_topic: "주제",
      lecture_description: "설명",
      prerequisite: "선수과목",
      syllabus: "강의계획안ddd",
      items: [
        {supply_id:1, name:'디지털', price:"100000", quantity:10, additional_info:"기타 정보입니다기타 정보입니다기타 정보입니다기타 정보입니다."},
        {supply_id:2, name:'디지털', price:"100000", quantity:10, additional_info:"기타 정보입니다."},
        {supply_id:3, name:'디지털', price:"100000", quantity:10, additional_info:"기타 정보입니다."},
        {supply_id:4, name:'디지털', price:"100000", quantity:10, additional_info:"기타 정보입니다."}
      ]
    }
  ...
  const handleSubmit = (e) => {
    ...
    fetch('/api/management/class/supplies/edit', {
      method: 'POST',
      body: formDataObj
    })
      .then((res) => {
  ...
  return (
    <div className="p-8">
      <title>Shark 관리페이지 | 물품 정보 수정</title> 

      <h1 className="pageTitle">강의 / 물품 정보 수정</h1>
      <Card className="box ">
